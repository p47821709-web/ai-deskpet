  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 space-y-8">
      <div className="text-center space-y-4 py-12">
        <h1 className="text-4xl font-bold tracking-tight">🐾 AI 桌宠</h1>
      ...
      <div className="grid gap-6 md:grid-cols-3">
        <Card>
          <CardContent className="pt-6 space-y-2">
            ...
            <p className="text-sm text-muted-foreground">上传图片，AI 自动转换为像素风桌宠，保持原角色特征</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="pt-6 space-y-2">
            ...
            <p className="text-sm text-muted-foreground">支持 OpenAI、DeepSeek、豆包，流式输出，桌宠有情绪有记忆</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="pt-6 space-y-2">
      ...
      <Card className="bg-muted/50">
        <CardContent className="py-6 space-y-3">
          ...
          <ol className="list-decimal list-inside space-y-2 text-sm text-muted-foreground">
            <li>前往<strong>设置 → AI 模型</strong>配置 API Key（支持 OpenAI / DeepSeek / 豆包）</li>
